...
prime_bloody_calamity_cheat = NoCooldownSpell('prime_bloody_calamity', Bind('space', 'left', hold_bind), 0.25, get_attack_speed)
...
# Calamity Combos
calamity_combo = Combo([prime_bloody_calamity, prime_bloody_calamity_cheat, engulfing_shadow])
midnight_calamity = Combo([prime_midnight_stinger, prime_bloody_calamity, prime_bloody_calamity_cheat, engulfing_shadow])
violation_calamity = Combo([prime_violation, prime_bloody_calamity, prime_bloody_calamity_cheat, engulfing_shadow])
eruption_calamity = Combo([prime_shadow_eruption, prime_bloody_calamity, prime_bloody_calamity_cheat, engulfing_shadow])
crow_calamity = Combo([prime_crow_flare, prime_bloody_calamity, prime_bloody_calamity_cheat, engulfing_shadow])
